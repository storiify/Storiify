...
<!--FINAL - MODAL MITO-->
<!--MODAL MAGIA-->
<div class="modal fade" id="modalCadastrarMagia" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document" >
        <div class="modal-content" >
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Cadastrar Magia</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form id="formModalMagia" class="form-horizontal">
                    <!--NOME - INPUT TEXTO-->
                    <div class="form-group">
                        <div class="row">
                            <!--INPUT CONTROLE-->
                            ...
                            <div class="col-md-12 input-corpo">
                                <div class="col-md-12 input-conteudo"> 
                                    <textarea name="rgrs_magi" value="" 
                                              ...
                                              id="input-txarea-Regras"></textarea>
                                </div>
                                <!--NÃO TEM DETALHES-->
                            </div>
                            <!--FINAL - INPUT CORPO-->
                    ...
                    <!--FINAL - INPUT TEXTOAREA-->
                    <div class="col-md-12 form-controle">
                        <input type="hidden" name="pk_magi" value="">
                        <button type="button" id="btn-salvar-form" class="btn btn-azul btn-block salvar-magia-modal">
                            Salvar Magia
                        </button>
                    </div>
                </form>
