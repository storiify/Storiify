...
<div class="conteudo">
    ...
    <div class='pos-cabecalho mx-auto'>
        <a href='?categoria=<?= $categoria ?>&acao=cadastrar' 
           title='Clique para criar uma nova <?= ModeloLingua::$nomeSingular ?>'
           class='btn btn-azul criar-nova-instancia'>
            <i class="fa fa-plus"></i>
            &nbsp&nbspCriar nova <?= ModeloLingua::$nomeSingular ?>
        </a>
    ...
    if (isset($resultados)) {
        foreach ($resultados as $modeloArray) {
            $lingua = new ModeloLingua($modeloArray);
            $nome = ($lingua->nm_lnga());

            $camposListar = "";
            foreach ($lingua->getAtributosListar() as $nomeCampo => $valorCampo) {
                $camposListar .= "<tr>"
            ...
            . "class='instancia-card mx-auto row clicavel' data-id='{$lingua->pk_lnga()}' data-nome='$nome'>"
            ...
            . "        </div>"
            . "    </div>"
            . "    <a href='?categoria=$categoria&acao=editar&id={$lingua->pk_lnga()}'></a>"
            ...
            . "        </button>"
            . "        <a href='?categoria=$categoria&acao=excluir&id={$lingua->pk_lnga()}' class='deletar-instancia-escondido'></a>"
    ...
    if (!isset($lingua)) {
        ...
        . "	    <span>" . "Seus " . ModeloLingua::$nomePlural . " aparecerão aqui" . "</span>"
        . "	</div>"
