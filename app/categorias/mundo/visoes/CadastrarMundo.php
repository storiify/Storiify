...
<div class="conteudo">
    ...
    <form action="?categoria=mundo&acao=salvar" method="post">
            ...
            <div id="abaGeral" class="container tab-pane active">
                ...
                <div class="form-group">
                    <div class="row">
                        ...
                        <div class="col-md-12 input-corpo">
                            <div class="col-md-12 input-conteudo">
                                <input name="view_nm_ppl" value="<?php echo (isset($modelo->nm_ppl)) ? $modelo->nm_ppl : ""; ?>" type="text" class="form-control" placeholder="Placeholder para Nome" id="input-tx-Nome"/>
                            </div>
                            <!--DETALHES-->
                            <div class="col-md-12 input-detalhes">
                                <a class="detalhes-link">Adicionar Detalhes</a>
