...
<div class='pos-cabecalho mx-auto'>
	...
	if(isset($resultados)){
		foreach ($resultados as $cena) {
			$modelo = (object) $cena;
			$titulo = $modelo->tit_cena;
			$imagemPrincipal = (isset($modelo->im_cena)) ? $modelo->im_cena : const_Indefinida_IM;
			echo
		   "<div title='Clique para editar $titulo'"
			. "class='instancia-card mx-auto row' data-id='$modelo->pk_cena' data-titulo='$titulo'>"
			...
			. "                    </tr>"
			. "                    <tr>"
			. "                        <th scope='row'>Cena Anterior:</th>"
			. "                        <td>" . $modelo->fk_cena_ant . "</td>"
			. "                    </tr>"
			. "                    <tr>"
			. "                        <th scope='row'>Cena Posterior:</th>"
			. "                        <td>" . $modelo->fk_cena_ptrr . "</td>"
			. "                    </tr>"
			. "                </table>"
			. "                    <tr>"
			. "                        <th scope='row'>Resumo da Cena:</th>"
			...
			. "        <button class='btn btn-azul btn-deletar-instancia' title='Clique para deletar $titulo'>"
			. "            <i class='fa fa-times'></i>"
			. "        </button>"
			. "        <a href='?categoria=$categoria&acao=excluir&id=$modelo->pk_cena' class='deletar-instancia-escondido'></a>"
			...
			. "title='" . ($titulo == "" ? " Clique para gerar PDF" : "Clique para gerar PDF de " . $titulo) . " '>"
