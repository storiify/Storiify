							...
							<input type='file' id="imgUploader" style="display:none;" />
								...
								<div class="form-group">
									...
									<div class="col-sm-3">
									 ...
									 <label for="txtData" class="col-sm-2 control-label">Data de Nascimento</label>
									<div class="col-sm-3">
										<input type="date" class="form-control" id="inputData" placeholder="Digite seu Subtítulo aqui" />
									</div>
								</div>
