...
$resultado = ($controlador->getResultados() == null ? 
        new ModeloHabilidade_fisica(array()) : $controlador->getResultados());
?>
...
<div id="titulo-bg">
    <div id="categoria-titulo" class="row">
        <h1><?= (empty($resultado->nm_hbld_fsca()) ? ModeloHabilidade_fisica::$nomeSingular : $resultado->nm_hbld_fsca(30)) ?></h1>
    </div>
</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 input-corpo">
                            <div class="col-md-12 input-conteudo">
                                <input name="nm_hbld_fsca" value="<?= $resultado->nm_hbld_fsca() ?>" 
                        ...
                        <div class="col-md-12 input-corpo">
                            <div class="col-md-12 input-conteudo"> 
                                <textarea name="dcr_hbld_fsca" value="" 
                                          ...
                                          id="input-txarea-Descricao"><?= $resultado->dcr_hbld_fsca() ?></textarea>
                            </div>
                            <!--NÃO TEM DETALHES-->
                        </div>
                        <!--FINAL - INPUT CORPO-->
                        ...
                        <div class="col-md-12 input-corpo">
                            <div class="col-md-12 input-conteudo">
                                <input type="text" name="podr_hbld_fsca" 
                                       ...
                                       value="<?= $resultado->podr_hbld_fsca() ?>" id="input-minmax-poder"></input>
                            </div>
                        </div>
                        <!--FINAL - INPUT CORPO-->
                    </div>
