$(document).ready(function () {
    $("#formLoko").submit(function (event) {
        ...
        var input5 = $('input[name="ckBoxTermos"]:checked').length > 0;
        ...
        if (!input5) { //verifica se o termo de uso foi checkado
            alert("Para se registrar, você deve concordar com os termos de uso");
            return false;
        }
