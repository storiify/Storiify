...
var Utility = {
    ...
    toggle_leftbar: function() {
        ...
        if (menuCollapsed == "true") {
            ...
            $("#layout-static1").removeClass("col-md-1").addClass("col-md-2");
            $("#divCenter").removeClass("col-md-11").addClass("col-md-10");
        }
        else if (menuCollapsed == "false") {
            localStorage.setItem('collapsed_menu', "true");
            $("#layout-static1").removeClass("col-md-2").addClass("col-md-1");
            $("#divCenter").removeClass("col-md-10").addClass("col-md-11");
        }
